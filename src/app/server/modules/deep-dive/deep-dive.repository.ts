...
export class DeepDiveRepository {
	...
	static async getValidationSummary(reportId: number) {
		return ValidationRepository.getValidationSummary(reportId);
	}

	static async getValidationByRule(reportId: number) {
		return ValidationRepository.getValidationByRule(reportId);
	}

	static async getConfiguredValidationRules(reportId: number) {
		return ValidationRepository.getConfiguredValidationRules(reportId);
	}

	static async getAvailableValidationRules(reportId: number) {
		return ValidationRepository.getAvailableValidationRules(reportId);
	}
	...
	static async getValidationByCompany(
		...
		return ValidationRepository.getValidationByCompany(
			reportId,
			companyId,
			status,
		);

...
export default function SalesMinerDetailPage() {
    ...
    return (
      <div style={{ minHeight: "100vh", background: "#141414", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <Result
          ...
          extra={<Button type="primary" onClick={() => router.push("/sales-miner")}>Go to Sales Miner</Button>}
        />
      </div>
    );
  }
    ...
    return (
      <div style={{ minHeight: "100vh", background: "#141414", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <Result
          ...
          extra={<Button type="primary" onClick={() => router.push("/sales-miner")}>Back to list</Button>}
        />
      </div>
    );
  }

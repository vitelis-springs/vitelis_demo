...
export default function VitelisSalesScrapeCandidatesPage() {
    ...
    return (
      <div style={{ minHeight: "100vh", background: "#141414", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <Result
          ...
          extra={<Button type="primary" onClick={() => router.push("/vitelis-sales")}>Back to list</Button>}
        />
      </div>
    );
  }

  return <ScrapeCandidatesAnalytics reportId={reportId} companyId={companyId} basePath="/vitelis-sales" />;
}

...
export default function DeepDiveSettings({
	reportId,
	backHref,
}: {
	reportId: number;
				...
				<div style={{ maxWidth: 1400, width: "100%" }}>
					...
					>
						...
						<div>
							<Title
								level={5}
								style={{ color: "#d9d9d9", marginTop: 0, marginBottom: 16 }}
							>
								General
							</Title>
							...
							<Title level={5} style={{ color: "#d9d9d9", marginBottom: 16 }}>
								Report Settings
							</Title>

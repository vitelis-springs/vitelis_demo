...
interface SalesMinerAnalyzeResultProps {
	quizData: SalesMinerQuizData;
	resultText?: string;
	onReset: () => void;
}

export default function SalesMinerAnalyzeResult({
	quizData,
	resultText,
	onReset,
}: SalesMinerAnalyzeResultProps) {
					...
					<div style={{ width: "100%" }}>
						...
						>
							...
							<div style={{ textAlign: "center", marginBottom: "32px" }}>
								...
								>
									SalesMiner Analysis Report Generated
								</Title>

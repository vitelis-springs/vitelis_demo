...
} from "../../hooks/api/useAnalyzeService";
...
function RegularAnalysisHistory() {
	...
	const userQuery = useGetAnalyzesByUser(
		user?._id || null,
		currentPage,
		pageSize,
	);
				...
				{isLoadingAnalyses ? (
											...
											>
												...
												>
													...
													{isAdmin() && analysis.user && (
														<Text
															style={{ color: "#58bfce", fontSize: "12px" }}
														>
					...
					>
						<Empty
							...
							description={
								<Text style={{ color: "#8c8c8c" }}>
									No analysis history found. Start a new company analysis to see
									it here.
								</Text>
							}
						/>

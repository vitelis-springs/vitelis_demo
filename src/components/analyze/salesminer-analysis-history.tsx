...
import {
	useGetAllSalesMinerAnalyzes,
	useGetSalesMinerAnalyzesByUser,
	useSalesMinerAnalyzeService,
} from "../../hooks/api/useSalesMinerAnalyzeService";
...
export default function SalesMinerAnalysisHistory() {
	...
	const userQuery = useGetSalesMinerAnalyzesByUser(
		user?._id || null,
		currentPage,
		pageSize,
	);
	...
	useEffect(() => {
		console.log(
			"📊 SalesMinerAnalysisHistory: analyses length:",
			analyses.length,
		);
	}, [analyses]);
				...
				{isLoadingAnalyses ? (
					...
					>
						<Space orientation="vertical" size="large">
							...
							<Text style={{ color: "#8c8c8c" }}>
								Loading SalesMiner analysis history...
							</Text>
						</Space>
					</Card>
				) : analyses.length > 0 ? (
											...
											>
												...
												>
													...
													<Text style={{ color: "#8c8c8c", fontSize: "12px" }}>
														...
														{analysis.useCase || "N/A"}
													</Text>
													<Text style={{ color: "#8c8c8c", fontSize: "12px" }}>
														<strong>Timeline:</strong>{" "}
														{analysis.timeline || "N/A"}
													</Text>
												</div>
					...
					>
						<Empty
							...
							description={
								<Text style={{ color: "#8c8c8c" }}>
									No SalesMiner analysis history found. Start a new SalesMiner

...
export default function Dashboard() {
	...
	return (
		<Layout style={{ minHeight: "100vh", background: "#141414" }}>
			<Sidebar />
			<Layout
				style={{ marginLeft: SIDEBAR_MARGIN_LEFT, background: "#141414" }}
			>
				<Content
					style={{
						padding: "24px",
					...
					<div style={{ maxWidth: "1200px", margin: "0 auto" }}>
						...
						<Row gutter={[24, 24]} style={{ marginBottom: "24px" }}>
							<Col xs={24} sm={12} lg={8}>
								...
								>
									<Statistic
										title={
											<span style={{ color: "#d9d9d9" }}>Active Sessions</span>
										}
										value={1}
										prefix={<LockOutlined style={{ color: "#58bfce" }} />}
										styles={{ content: { color: "#58bfce" } }}
									/>
							...
							<Col xs={24} sm={12} lg={8}>
								...
								>
									<Statistic
										title={
											<span style={{ color: "#d9d9d9" }}>Storage Used</span>
										}
										value={2.4}
										suffix="GB"
							...
							<Col xs={24} sm={12} lg={8}>
								...
								>
									<Statistic
										title={
											<span style={{ color: "#d9d9d9" }}>System Status</span>
										}
										value="Online"
										prefix={
						...
						<Row gutter={[24, 24]}>
							<Col xs={24} lg={12}>
								...
								>
									<Descriptions column={1} size="small">
										...
										<Descriptions.Item
											label={
												<span style={{ color: "#d9d9d9" }}>Authentication</span>
											}
										>
											<Tag color="blue">Client-side with Zustand</Tag>
										</Descriptions.Item>
										<Descriptions.Item
											label={<span style={{ color: "#d9d9d9" }}>Storage</span>}
										>
											<Tag color="green">Persistent (localStorage)</Tag>
										</Descriptions.Item>
										<Descriptions.Item
											label={<span style={{ color: "#d9d9d9" }}>Session</span>}
										>
											<Tag color="success">Active</Tag>
										</Descriptions.Item>
										<Descriptions.Item
											label={
												<span style={{ color: "#d9d9d9" }}>Last Login</span>
											}
										>
							...
							<Col xs={24} lg={12}>
								<Card
									title={
										<span style={{ color: "#d9d9d9" }}>System Information</span>
									}
									style={{ background: "#1f1f1f", border: "1px solid #303030" }}
									size="default"
								>
									<Descriptions column={1} size="small">
										<Descriptions.Item
											label={<span style={{ color: "#d9d9d9" }}>Platform</span>}
										>
										...
										<Descriptions.Item
											label={
												<span style={{ color: "#d9d9d9" }}>UI Framework</span>
											}
										>
											<Tag color="cyan">Ant Design</Tag>
										</Descriptions.Item>
										<Descriptions.Item
											label={<span style={{ color: "#d9d9d9" }}>Language</span>}
										>
											<Tag color="blue">TypeScript</Tag>
										</Descriptions.Item>
										<Descriptions.Item
											label={<span style={{ color: "#d9d9d9" }}>Version</span>}
										>
											<Text strong style={{ color: "#fff" }}>
												1.0.0
											</Text>
